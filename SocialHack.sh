...
sleep 0.5
echo ""
echo -e "[$red!$farblos] Attack$red $user $farblos"
echo ""
...
pw_found() {
echo ""
echo -e " $green Password found!$BlueF     $farblos"
echo -e " $magenta ---------------$BlueF  $farblos"
echo -e " $green Username$farblos: $yellow$user $farblos"
echo -e " $green Password$farblos: $yellow$pass $farblos"
echo -e ""
echo -e " $lightgreen HANGUUUUUP!$yellow:) $farblos"
echo ""
eingabe
}
